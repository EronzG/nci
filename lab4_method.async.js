...
const web3 = new Web3('https://ropsten.infura.io/v3/[your infura account]')
...
const contractAddress = '0xF74Cc843D643709869c1dA4E068B3fB57FD71630'
...
const go = async() => {
  ...
  await transferFunds(account1, account2, 100)
}
